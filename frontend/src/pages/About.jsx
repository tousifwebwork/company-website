        ...
        <section id="about" className='mt-10 flex flex-col items-center px-4 py-4 w-full' >
            ...
            <section className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-10 w-full max-w-6xl">
                ...
                <div className="text-sm text-slate-600 max-w-lg text-center md:text-left">
                    ...
                    <p className="mt-8">
We help businesses transform ideas into scalable digital products by delivering modern, high-performance software solutions.
</p>

<p className="mt-4">
From web applications and mobile platforms to cloud-native systems, our team builds secure, fast, and user-friendly solutions tailored to real-world business needs.
</p>
